# Flashing esp32-nut-bluetti

`esp32-nut-bluetti-<version>-factory.bin` (from the
[latest release](https://github.com/thatguy-za/esp32-nut-bluetti/releases/latest))
...
`esp-nut-bluetti-XXXX`. Join it, the captive portal opens (or browse to
...
`esp32-nut-bluetti.bin` from a later release; it's written to the spare OTA slot
...
| `0x20000` | `esp32-nut-bluetti-<version>.bin` |
